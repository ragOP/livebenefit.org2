...
// sds
  const handleOptionClick = (option) => {
    if (option === "👉 Yes! Show me how to claim!") {
        window.open(
            "https://wa.me/12086099957?text=Yes%2C%20Help%20Me%20Claim%20The%20%2440%2C000%20Burial%20Protection%20Plan!",
            "_blank"
        );
    //   setMessages((prev) => [
    //     ...prev,
  ...
  return (
    ...
    >
      <div className="bg-[#3423cf] text-white p-4 flex items-center gap-2 shadow-md sticky top-0 right-0 left-0 z-10 h-16">
        <img
          src={agent}
          alt="Psychic Master"
      ...
      <div className="flex-1 p-4 space-y-2 overflow-y-auto flex flex-col mt-[1%] pb-52">
        ...
        {showInput && (
          <div className="mt-2 flex items-center gap-2 justify-end">
            ...
            />
            <button
              className="px-5 py-4 bg-[#3423cf] text-white rounded-2xl"
        ...
        {currentOptions.length > 0 && (
          <div className="flex flex-wrap gap-2 mt-2 items-center justify-start ms-10">
            {currentOptions.map((option, i) => (
              <button
                key={i}
                className="px-6 py-3 bg-[#3423cf] text-white rounded-full text-lg"
